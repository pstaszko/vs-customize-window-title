...
namespace ErwinMayerLabs.RenameVSWindowTitle {
    ...
    public class SettingsOverridesPageGrid : DialogPage {
        ...
        [Description("Default: Empty. If not empty, and 'Enable solution-specific overrides' is set to true, will try to use overrides from the file at this path. It should be in xml format containing multiple RenameVSWindowTitle/SettingsSet elements as for .sln.rn.xml files, with the addition of a Path attribute or child node(s) to specify to which solution path(s) or solution name(s) each SettingsSet is applicable (case insensitive wildcards are supported). Overrides from this global file take precedence over those found in .sln.rn.xml files.")]
        ...
        protected override void OnActivate(CancelEventArgs e) {
            ...
            if (RenameVSWindowTitle.CurrentPackage != null) {
                ...
                var gfp = RenameVSWindowTitle.CurrentPackage.SettingsOverrides.GlobalSolutionSettingsOverridesFp;
