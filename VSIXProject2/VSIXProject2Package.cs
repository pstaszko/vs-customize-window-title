...
namespace VSIXProject2
{
	...
	public sealed class VSIXProject2Package : AsyncPackage
	{
		...
		/// </summary>
		public const string PackageGuidString = "03656b80-962e-4c6c-9ef8-983d5f03c326";
		...
		protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
		{
			...
			await System.Threading.Tasks.Task.Run(() => System.IO.File.WriteAllText(q, "a"));
		...
		{
			System.IO.File.WriteAllText(@"c:\temp\xxxx.txt", "a");
			return base.GetService(serviceType);
		}
		protected override string GetToolWindowTitle(Type toolWindowType, int id)
		{
			System.IO.File.WriteAllText(@"c:\temp\xxx.txt", "a");
			return base.GetToolWindowTitle(toolWindowType, id);
		}
		protected override Task OnAfterPackageLoadedAsync(CancellationToken cancellationToken)
		{
			System.IO.File.WriteAllText(@"c:\temp\xx.txt", "a");
